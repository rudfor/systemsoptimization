        ...
        while PTs > 0 and len(separations) > 0:
            ...
            while not foundSchedulableSeparation and len(separations) > 0:
                ...
                for budget in range(1, period):
                    ...
                    schedulable, responseTime = libs.AlgoTwo.schedulingET(pollingTask[0], pollingTask[1],
                                                                          pollingTask[2], sublistET)
            ...
            if foundSchedulableSeparation:
                ...
                print('Add pooling schedulable task with separation:', separation, 'and budget:', bestBudget,
                      'and period:', period)
                TT.append(task)
