...
class MainTest(TestCase):
    ...
    def test_successful_scheduling_of_two_ET(self):
        ...
        for budget in range(1, period):
            ...
            schedulable, responseTime = main.schedulingET(pollingTask[0], pollingTask[1], pollingTask[2], inputTasksET)
    ...
    def test_successful_scheduling_of_TT_and_one_PT(self):
        ...
        self.assertEqual('tPT1', schedule[2055].name)
        self.assertEqual(1195, schedule[2055].computation)
        self.assertEqual('tPT1', schedule[3249].name)
